                        ...
                        <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                                    ...
                                    <span>+8801609114142</span>
                                </p>
                            </div>
                        </div>

                        <LinkGroup header="Support">
                            <NavLink link="/#" label="111 Bijoy sarani, Dhaka,  DH 1515, Bangladesh." />
                            <NavLink link="/#" label="ibrahim06978@gmail.com" />

                        </LinkGroup>
                        <LinkGroup header="Account">
                            <NavLink link="/#" label="My Account" />
                            <NavLink link="/#" label="Login / Register" />
                            <NavLink link="/#" label="Cart" />
                            <NavLink link="/#" label="Wishlist" />
